...
const STORAGE_KEY = "metodo-epc-demo-facebook";
...
const initialData: FacebookData = {
          ...
          <div key={category}>
            ...
            <div className="space-y-1">
              {planningModules
                ...
                .map((module) => {
                  const isActive = module.slug === "facebook";
...
export default function FacebookPage() {
  const [data, setData] = useState<FacebookData>(initialData);
      ...
      setData({
        ...
        visualReferences:
          ...
          parsed.visualReferences.length
            ...
            : [{ image: "" }, { image: "" }, { image: "" }],
        pagePhoto: parsed.pagePhoto || "",
        pageCover: parsed.pageCover || "",
          ...
          <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-slate-600">
                Descreva as características que os posts do Facebook devem ter,
                incluindo página, capa, foto de perfil, frequência, objetivos,
                linguagem, conteúdos, identidade visual e links importantes.
              </p>
