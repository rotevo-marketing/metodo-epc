...
const STORAGE_KEY = "metodo-epc-demo-pinterest";
...
const initialData: PinterestData = {
          ...
          <div key={category}>
            ...
            <div className="space-y-1">
              {planningModules
                ...
                .map((module) => {
                  const isActive = module.slug === "pinterest";
...
export default function PinterestPage() {
  const [data, setData] = useState<PinterestData>(initialData);
  ...
  useEffect(() => {
    ...
    try {
      ...
      setData({
        ...
        mainBoards: parsed.mainBoards || "",
        priorityVisualThemes: parsed.priorityVisualThemes || "",
        ...
        visualReferences:
          ...
          parsed.visualReferences.length
            ...
            : [{ image: "" }, { image: "" }, { image: "" }],
        pinKeywords: parsed.pinKeywords || "",
        destinationLinks: parsed.destinationLinks || "",
        descriptionGuidelines: parsed.descriptionGuidelines || "",
        references:
          ...
          <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-slate-600">
                Descreva as características que as imagens do Pinterest devem
                ter. Defina frequência, objetivos, linguagem, identidade visual,
                pastas, pins, referências e links que podem ser usados para
                gerar descoberta e tráfego.
              </p>
