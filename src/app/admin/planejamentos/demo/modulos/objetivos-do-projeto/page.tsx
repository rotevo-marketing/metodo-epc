...
const STORAGE_KEY = "metodo-epc-demo-objetivos-do-projeto";
...
const initialData: ProjectObjectivesData = {
  mainObjective: {
    title: "",
    description: "",
  },
          ...
          <div key={category}>
            ...
            <div className="space-y-1">
              {planningModules
                ...
                .map((module) => {
                  const isActive = module.slug === "objetivos-do-projeto";
...
export default function ObjetivosDoProjetoPage() {
  const [data, setData] = useState<ProjectObjectivesData>(initialData);
          ...
          <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-slate-600">
                Defina os objetivos que o planejamento precisa alcançar, as
                prioridades estratégicas, os indicadores de sucesso, os
                resultados esperados e as fases de evolução do projeto.
              </p>
